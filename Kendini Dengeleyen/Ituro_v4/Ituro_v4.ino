...
// PID
//const float Kp = 12; //Çokİyi gibi
//const float Ki = 1.2; //Çokİyi gibi
//const float Kd = 0.72; //Çokİyi gibi
const float Kp = 11.75; //Çokİyi gibi
const float Ki = 1.38; //Çokİyi gibi
const float Kd = 3;
//const float Kp = 12; 
...
void loop() {
 ...
 //   Serial.println(error);
    if (CurrentAngle <= 181.3 && CurrentAngle >= 178.7)
    {
      dur();
    }
    else{
